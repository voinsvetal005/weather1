...
async def get_weather(message: types.Message):
    ...
    try:
        ...
        #await bot.send_message(channel_id, f"Сегодня {datetime.datetime.now().strftime('%d-%m-%Y')}. " #f"***{datetime.datetime.now().strftime('%Y-%m-%d %H:%M')}***\n"
              ...
              #)
        #await bot.send_photo(channel_id, 'https://photos.app.goo.gl/tc5MjoGnpx1uc6339', caption='Декабрь – стужайло на всю зиму землю студит. Он и замостит, и загвоздит, и саням ход даст!')
